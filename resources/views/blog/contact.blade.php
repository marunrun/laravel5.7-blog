            ...
            <form action="/contact" method="post" name="sendMessage" id="contactForm" novalidate>
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>姓名</label>
                        <input type="text" name="name" class="form-control" placeholder="请填写你的名字" id="name"
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>邮箱</label>
                        <input type="email" name="email" class="form-control" placeholder="请填写你的邮箱" id="email"
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>手机</label>
                        <input type="tel" name="phone" class="form-control" placeholder="请填写你的手机号" id="phone"
                ...
                <div class="control-group">
                    <div class="form-group floating-label-form-group controls">
                        <label>消息</label>
                        <textarea name="message" class="form-control" placeholder="填写你想发送的消息" id="message"
